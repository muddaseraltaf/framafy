      ...
      <section className="text-center space-y-10 max-w-5xl mx-auto pt-10 px-4">
        <div className="space-y-6">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-black tracking-tighter text-neutral-900 leading-[1.1]">
            Turn Your Photo Into <br /><span className="bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-purple-600">Meaningful Art.</span>
          </h1>
          <p className="text-xl md:text-2xl text-neutral-600 leading-relaxed font-light max-w-3xl mx-auto">
            The premium alternative to diamond painting. Upload your most precious memories and bring them to life, dot by dot. Relax, unwind, and create a truly personal masterpiece.
          </p>
        </div>
